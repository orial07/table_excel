...
<div class="row">
<div class="col-sm-20" id="printTable" >
<table class="table table-bordered" id="tbl">
  ...
  for($t=0;$t<3;$t++) 
    ...
    <tr  id='containertx' >
      ...
      <td ><textarea name="field[]" class="form-control" rows="2" placeholder="Multiline textarea" required="required"></textarea></td>
      <td ><textarea  name="field[]" class="form-control" rows="2" placeholder="Multiline textarea" required="required"></textarea></td>
      <td ><textarea  name="field[]"class="form-control" rows="2" placeholder="Multiline textarea" required="required"></textarea></td>
    </tr>
   <?php }  ?>
...
<button id='save' class="btn btn-info btn-lg">
    ...
    <button type="button" class="btn btn-info btn-lg" id='printMe'>
      <span class="glyphicon glyphicon-print"></span> Print 
    </button>

    <button id='send' class="btn btn-info btn-lg">
...
$('#printMe').click(function(){
 ...
 alert("You must login to use Print Table")
});
...
$('#save').click(function(){
 ...
 alert("You must login to use Save Table")
});

$('#send').click(function(){

 alert("You must login to use Send Table")
});
...
//Add Column to the table
 $("#addcol").click(function(){
  $("#printTable tr:gt(0)").append("<td > <textarea  'name='field[] 'class='form-control'rows='2' placeholder='Multiline textarea' required='required'></textarea> </td>")
...
$(document).ready(function() {
    ...
    $(add_button).click(function(e){ //on add input button click
        ...
        if(x < max_fields){ //max input box allowed
            ...
            $(wrapper).append('<div class="form-inline"><input type="text" name="fname[]"/ class="form-control" placeholder="Field Name" required="required"> <input type="text" name="ftext[]"/ class="form-control" placeholder="Description" required="required"><button class="remove_field"> <span  class="glyphicon glyphicon-remove" ></span></button></div>'); 
        }
    });
